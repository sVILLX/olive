document.addEventListener("DOMContentLoaded", () => {
    ...
    const confirmationMessage = '¿Seguro que quieres hacer reset? Tus cambios se perderán.';
...
// `;
    ...
    document.querySelector('#nuevoArticulo').addEventListener('show.bs.modal', () => {
        presetValue(defaultInput); // Limpia el editor
        document.querySelector('#output').innerHTML = ''; // Limpia la vista previa
    });
});
